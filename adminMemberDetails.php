...
<div class="class-pos" style="display:block; margin-top:15em;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
         ...
         <div class="ad-btn">
            ...
            <li class="p-2">
                <a class="btn btn-info"  href="?name=memid"><i class="fas fa-edit"></i> <span> Update</span></a>
            </li>  
            ...
            ?>
              ...
              <?php
                 if (isset($_GET['name'])) {
                    switch ($_GET['name']) {
                        case 'add':
                            include_once 'dataHandle/addMember.php';
                            break;
                        case 'memid':
                            include_once 'dataHandle/upMemSearchId.php';
                            break;
                        ...
                        default:
                        ?>    
                           <h1 class="ad-text">Welcome to the Member Details</h1> 
                        <?php
                            break;
                ...
                include_once 'dataHandle/DeleteMember.php';  
                    ...
                    switch ($_GET['result']) {
                        ...
                        case 'na':
                            ?>
                            <h1 class="ad-text">You can only update this Member</h1> 
                            <?php
                            break;
                        default:
                            ?>
