            ...
            ?>
              ...
              <?php
                 if (isset($_GET['name'])) {
                    switch ($_GET['name']) {
                        case 'add':
                            include_once 'dataHandle/eventAdd.php';
                            break;
                        case 'update':
                            include_once 'dataHandle/eventUpdateId.php';
                            break;
                        // case 'update':
                        ...
                        //     break;
                        case 'delete':
                            include_once 'dataHandle/eventDelete.php';
                            break;
                    
                        default:
                        ?>    
                           <h1 class="ad-text">Welcome to the Events Panel</h1> 
                        <?php
                            break;

                    }
              } else  if (isset($_GET['eventid'])) {
                     include_once 'dataHandle/eventUpdate.php';  
                ...
                include_once 'dataHandle/DeleteMember.php';  
                    ...
                    switch ($_GET['result']) {
                        ...
                        case 'na':
                            ?>
                            <h1 class="ad-text">You can only update this Event</h1> 
                            <?php
                            break;
